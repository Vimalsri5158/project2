      ...
      <div className={style.section4}>
        ...
        <div className={style.body}>
          <p>
            ...
            order <br /> to reduce CSS bloat and poor page performance. Custom CSS
            classes<br />  are used to create custom components and custom utility
            classes.
          </p>
          <p>
            Before working with this theme, you should become familiar with the<br /> 
